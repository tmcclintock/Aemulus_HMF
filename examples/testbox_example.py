...
if __name__ == "__main__":
    ...
    for snapshot in range(len(sfs)):
        ...
        if snapshot == 6 or snapshot == 7 or snapshot == 8: continue
        a = sfs[snapshot]
        z = zs[snapshot]
    ...
    plt.subplots_adjust(hspace=0, wspace=0, left=0.15, bottom=0.15)
    axarr[0].legend(loc=0, frameon=0, fontsize=10)
